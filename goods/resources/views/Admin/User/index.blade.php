        ...
        <div class="row items-push">
            ...
            <div class="col-sm-5 text-right hidden-xs">
                <ol class="breadcrumb push-10-t">
                    <li>表格</li>
                    <li><a class="link-effect" href="">用户列表显示</a></li>
                </ol>
            </div>
        </div>
    </div>
                            ...
                            @endif
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        ...
                                        <button class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="" data-original-title="放入回收站"><a href="/Admin/User/inrecycle/{{$v['id']}}"><i class="fa fa-recycle"></i></a></button>
                                    </div>
                                </td>
                            </tr>
                            @endforeach
