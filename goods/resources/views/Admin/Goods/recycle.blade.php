...
@section('container')
    ...
    <div class="block">
        <div class="block-header">
            <h3 class="block-title">查看下架商品</h3>
        </div>
                        ...
                        <tr role="row" class="even">
                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                    ...
                                    <button class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="" data-original-title="上架"><a href="/Admin/Goods/outrecycle/{{$v['id']}}"><i class="fa fa-reply"></i></a></button>
                                </div>
                            </td>
                        </tr>
                        @endforeach
